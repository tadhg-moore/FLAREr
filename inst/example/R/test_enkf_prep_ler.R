...
config$model_settings$model_name <- mod
...
file.copy(file.path(configuration_directory, "forecast_model", "ler", "LakeEnsemblR.yaml"), execute_directory)
file.copy(file.path(configuration_directory, "forecast_model", "ler", "LakeEnsemblR_bathymetry_standard.csv"), execute_directory)
